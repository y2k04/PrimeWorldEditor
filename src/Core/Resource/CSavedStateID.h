...
public:
    ...
    constexpr CSavedStateID(uint64_t Part1, uint64_t Part2) : m{{Part1, Part2}}
    {
    }
    ...
    {
        const uint32_t Part1 = (m[0] >> 32) & 0xFFFFFFFF;
        const uint32_t Part2 = (m[0] >> 16) & 0x0000FFFF;
        const uint32_t Part3 = (m[0] >> 00) & 0x0000FFFF;
